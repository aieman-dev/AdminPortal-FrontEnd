...
import { 
    User, Car, MapPin, Briefcase, CreditCard, Smartphone, Home, ScanLine, Users
} from "lucide-react"
                ...
                <CardContent className="p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-1.5">
                            <div className="relative">
                                <span className="absolute left-3 top-3.5 text-xs text-muted-foreground font-bold">01</span>
                                <Input {...register("plate1")} className={cn(inputClass, "pl-8 uppercase border-indigo-200 bg-indigo-50/10 focus:bg-background")} placeholder="Required" />
                                {errors.plate1 && <span className="text-[10px] text-red-500 font-medium absolute -bottom-4 left-0">{errors.plate1.message}</span>}
                            </div>
                            <div className="relative">
                                <span className="absolute left-3 top-3.5 text-xs text-muted-foreground font-bold">02</span>
                                <Input {...register("plate2")} className={cn(inputClass, "pl-8 uppercase")} placeholder="Optional" />
                            </div>
                            <div className="relative">
                                <span className="absolute left-3 top-3.5 text-xs text-muted-foreground font-bold">03</span>
